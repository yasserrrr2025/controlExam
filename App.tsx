...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (tabToRender) {
      ...
      case 'print-sheets': return <PrintSheets students={students} examSchedule={examSchedule} systemConfig={systemConfig} users={users} supervisions={allSupervisions.filter(i => !isReserveSupervision(i))} deliveryLogs={allDeliveryLogs} />;
