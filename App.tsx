...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    ...
    switch (tabToRender) {
      ...
      case 'committees': return <AdminSupervisionMonitor supervisions={supervisions} users={users} students={students} absences={absences} deliveryLogs={deliveryLogs} controlRequests={controlRequests} />;
